...
class ARAgeingSummaryView(APIView):
    ...
    def _calculate_ageing_bucket(due_date, today):
        """Calculate which ageing bucket an invoice falls into based on due date"""
    ...
    def get(self, request, *args, **kwargs):
        ...
        overdue_percentage = float((overdue_amount / total_ar * 100)) if total_ar > 0 else 0.0
        ...
        ageing_buckets = [
            {
                ...
                "percentage": float((buckets["current"] / total_ar * 100)) if total_ar > 0 else 0.0,
                "color": "#10B981",  # Green
            },
            {
                "label": "1-30 Days",
                ...
                "percentage": float((buckets["1_30_days"] / total_ar * 100)) if total_ar > 0 else 0.0,
            ...
            },
            {
                ...
                "percentage": float((buckets["31_60_days"] / total_ar * 100)) if total_ar > 0 else 0.0,
                "color": "#F97316",  # Orange
            },
            {
                "label": "61-90 Days",
                ...
                "percentage": float((buckets["61_90_days"] / total_ar * 100)) if total_ar > 0 else 0.0,
                "color": "#EF4444",  # Red
            },
            {
                "label": "90+ Days",
                ...
                "percentage": float((buckets["90_plus_days"] / total_ar * 100)) if total_ar > 0 else 0.0,
