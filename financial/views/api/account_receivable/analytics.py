...
class AnalyticsView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        outstanding_by_category = self._calculate_outstanding_by_category(
        ...
        collections_by_payment_method = self._calculate_collections_by_payment_method(
            company
        )
    ...
    def _calculate_invoiced_collected_trend(self, company, all_invoices, paid_invoices):
        ...
        for i in range(5, -1, -1):  # Last 6 months
            ...
            collected = paid_invoices.filter(
                updated_at__date__gte=month_start, updated_at__date__lte=month_end
    ...
    def _calculate_collections_by_payment_method(self, company):
        ...
        matched_transactions = BankTransaction.objects.filter(
            company=company, is_matched=True
        )
